...
public class MainActivity extends BaseActivity implements ObseverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objectid=sp.getString("objetid","error");
        //connect server
    ...
    private void initTab() {
        conversationFragment = new ConversationFragment(new ChangeFragment() {
            @Override
        ...
        contactFragment = new ContactFragment(new ChangeFragment() {
            @Override
            public void change(int flag) {

...
public class NewFriendActivity extends ParentWithNaviActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setListener();
        tv_tiele1= (TextView) findViewById(R.id.tv_title1);
        tv_tongzhi= (TextView) findViewById(R.id.tv_tongzhi);
        tv_left= (ImageView) findViewById(R.id.tv_left);
        gong2= (ImageView) findViewById(R.id.gong2);
        tv_tiele1.setVisibility(View.GONE);
        tv_tongzhi.setVisibility(View.GONE);
        tv_left.setVisibility(View.GONE);
        gong2.setVisibility(View.GONE);
    }
